...
const text = {
  is: {
    ...
    address: "Heimilisfang", addressPlaceholder: "Byrjaðu að skrifa stað eða heimilisfang", operationalLocation: "Verkstaður / staðsetning", operationalLocationHelp: "Byrjaðu að skrifa. GLÖGGT sýnir fyrst eigin staði og síðan opinber staðföng á Íslandi.", officialAddressSource: "HMS Staðfangaskrá", officialAddressSearching: "Leita í Staðfangaskrá…", workResourcesAtCreate: "Tæki / vinnuvélar á Verk", workResourcesAtCreateHelp: "Veldu tæki sem á að fylgja Verkinu. Ferðamáti og ferðahraði vinnuvéla fara sjálfkrafa inn í Dagsmönnun.", companyWorkBase: "Sjálfgefin starfsstöð fyrirtækis", companyWorkBaseMissing: "Engin sjálfgefin starfsstöð skráð", description: "Lýsing", descriptionPlaceholder: "Lýstu verkinu...", saveWork: "Vista verk", cancel: "Hætta við",

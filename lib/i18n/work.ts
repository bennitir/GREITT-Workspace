...
const text = {
  is: {
    ...
    address: "Heimilisfang", addressPlaceholder: "Heimilisfang verks", operationalLocation: "Rekstrarstaður / verkstaður", operationalLocationHelp: "Veldu þekktan rekstrarstað ef hann er til. Sjálfgefin starfsstöð fyrirtækis er upphafspunktur ferðatíma, ekki verkstaður.", companyWorkBase: "Sjálfgefin starfsstöð fyrirtækis", companyWorkBaseMissing: "Engin sjálfgefin starfsstöð skráð", description: "Lýsing", descriptionPlaceholder: "Lýstu verkinu...", saveWork: "Vista verk", cancel: "Hætta við",
  ...
  en: {
    ...
    address: "Address", addressPlaceholder: "Work address", operationalLocation: "Operational / work location", operationalLocationHelp: "Choose a known operational location when available. The company default work base is the travel origin, not the work site.", companyWorkBase: "Company default work base", companyWorkBaseMissing: "No default work base registered", description: "Description", descriptionPlaceholder: "Describe the work...", saveWork: "Save work order", cancel: "Cancel",
  ...
  pl: {
    ...
    address: "Adres", addressPlaceholder: "Adres wykonania pracy", operationalLocation: "Lokalizacja operacyjna / miejsce pracy", operationalLocationHelp: "Wybierz znaną lokalizację operacyjną, jeśli istnieje. Domyślna baza firmy jest punktem początkowym przejazdu, a nie miejscem pracy.", companyWorkBase: "Domyślna baza firmy", companyWorkBaseMissing: "Brak domyślnej bazy pracy", description: "Opis", descriptionPlaceholder: "Opisz zadanie...", saveWork: "Zapisz zadanie", cancel: "Anuluj",
  ...
  sr: {
    ...
    address: "Адреса", addressPlaceholder: "Адреса посла", operationalLocation: "Оперативна локација / место рада", operationalLocationHelp: "Изаберите познату оперативну локацију ако постоји. Подразумевана база компаније је полазна тачка путовања, а не место рада.", companyWorkBase: "Подразумевана база компаније", companyWorkBaseMissing: "Није евидентирана подразумевана база", description: "Опис", descriptionPlaceholder: "Опишите посао...", saveWork: "Сачувај посао", cancel: "Откажи",
